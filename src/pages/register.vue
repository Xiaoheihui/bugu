    ...
    <div class="login-session">
      ...
      <el-form :model="registerForm" status-icon :rules="rules" ref="registerForm" class="loginForm">
        <el-form-item label="" prop="phone">
          <el-input class="input-item" v-model="registerForm.phone" clearable placeholder="手机号"
                    prefix-icon="el-icon-user"></el-input>
        </el-form-item>
        <el-form-item label="" prop="password">
          <el-input class="input-item" type="password" v-model="registerForm.password" autocomplete="off"
                    placeholder="密码" clearable prefix-icon="el-icon-lock"></el-input>
        </el-form-item>
        <el-form-item label="" prop="pass_confirm">
          <el-input class="input-item" type="password" v-model="registerForm.pass_confirm" autocomplete="off"
                    placeholder="确认密码" clearable prefix-icon="el-icon-lock"></el-input>
        </el-form-item>
        <el-form-item>
