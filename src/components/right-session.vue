        ...
        <el-dialog title="填写聊天室资料" :visible.sync="groupInfoVisible" class="groupDialog">
          <el-form :model="acceptForm">
            <el-form-item label="聊天室名称">
              <el-input v-model="groupName" clearable maxlength="10" show-word-limit class="groupNameInput" type="text" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="聊天室简介">
              <el-input v-model="groupIntro" clearable maxlength="50" show-word-limit class="groupNameInput" type="textarea" autocomplete="off"></el-input>
            </el-form-item>
          </el-form>
