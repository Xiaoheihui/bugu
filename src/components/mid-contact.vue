	...
	<el-col :span="6" class="list">
		...
		<div class="groupList">
			...
			<div v-if="showSheets1" style="width:100%;">
				<div class="sheetList" v-for="i in contacts.group_list" :key="i.group_id" @click="groupDetail(i)">
					<div class="access">
		...
		<div class="groupList">
			...
			<div v-if="showSheets2" style="width:100%;">
				<div class="sheetList" v-for="i in contacts.friend_list" :key="i.friend_id" @click="friendDetail(i)">
					<div class="access">
						<div class="sheetImage">
